            ...
            <div className="score">
                <div>
                    <p>
                        ...
                        <br/>
                        <span className="bolder">Grade:</span> {this.props.score.grade}
                        <br />
                        <span className="bolder">Combos:</span> {this.props.score.combo < 0 ? '-' : this.props.score.combo}
                        <br/>
                        <span className="status clearRate">{this.props.score.clear_type}</span>
                    </p>
                </div>
...
var network_records = React.createClass({
                        ...
                        <p>
                            <SelectVersion
                                ...
                                onChange={function(version) {
                                    if (this.state.subtab == window.valid_mixes[version - 1]) { return; }
                                    this.setState({subtab: version, offset: 0});
                                    pagenav.navigate(this.state.sort, window.valid_mixes[version - 1]);
                                }.bind(this)}
                            />
                        </p>
                    </div>
    ...
    renderByScore: function() {
        ...
        return (
            <section>
                <h4>Difficulty - {chart_names[window.valid_charts[this.state.subtab]]}</h4>
                <p>
                    <SelectVersion
                        name="chart"
                        value={ this.state.subtab }
                        versions={ Object.values(window.chart_names) }
                    ...
                    <p>
                        ...
                        <SelectVersion
                            ...
                            onChange={function(event) {
                                ...
                                pagenav.navigate(event, valid_subsorts[event]);
                            }.bind(this)}
                        />
                    </p>
                </section>
