...
from bemani.data import Attempt, Score, UserID
...
class ReflecBeatReflesia(ReflecBeatBase):
    ...
    def handle_info_rb6_info_read_hit_chart_request(self, request: Node) -> Node:
    ...
    def handle_info_rb6_info_read_shop_ranking_request(self, request: Node) -> Node:
    ...
    def handle_lobby_rb6_lobby_entry_request(self, request: Node) -> Node:
    ...
    def handle_lobby_rb6_lobby_read_request(self, request: Node) -> Node:
        root = Node.void('lobby')
        root.add_child(Node.s32('interval', 120))
        root.add_child(Node.s32('interval_p', 120))
    ...
    def handle_lobby_rb6_lobby_delete_entry_request(self, request: Node) -> Node:
        eid = request.child_value('eid')
        self.data.local.lobby.destroy_lobby(eid)
        return Node.void('lobby')

    def handle_pcb_rb6_pcb_boot_request(self, request: Node) -> Node:
    ...
    def handle_pcb_rb6_pcb_error_request(self, request: Node) -> Node:
        return Node.void('pcb')

    def handle_pcb_rb6_pcb_update_request(self, request: Node) -> Node:
        return Node.void('pcb')

    def handle_shop_rb6_shop_write_setting_request(self, request: Node) -> Node:
        return Node.void('shop')

    def handle_shop_rb6_shop_write_info_request(self, request: Node) -> Node:
    ...
    def handle_player_rb6_player_start_request(self, request: Node) -> Node:
    ...
    def handle_player_rb6_player_end_request(self, request: Node) -> Node:
    ...
    def handle_player_rb6_player_delete_request(self, request: Node) -> Node:
        return Node.void('player')

    def handle_player_rb6_player_succeed_request(self, request: Node) -> Node:
        refid = request.child_value('rid')
        userid = self.data.remote.user.from_refid(self.game, self.version, refid)
        if userid is not None:
    ...
    def handle_player_rb6_player_read_request(self, request: Node) -> Node:
        refid = request.child_value('rid')
    ...
    def handle_player_rb6_player_read_score_old_5_request(self, request: Node) -> Node:
        root = Node.void('player')
    ...
    def handle_player_rb6_player_read_score_5_request(self, request: Node) -> Node:
        refid = request.child_value('rid')
        userid = self.data.remote.user.from_refid(self.game, self.version, refid)
        if userid is None:
            scores: List[Score] = []
    ...
    def handle_player_rb6_player_read_rival_score_5_request(self, request: Node) -> Node:
        extid = request.child_value('uid')
    ...
    def handle_player_rb6_player_read_rival_ranking_data_5_request(self, request: Node) -> Node:
        extid = request.child_value('uid')
        userid = self.data.remote.user.from_extid(self.game, self.version, extid)
    ...
    def handle_player_rb6_player_read_rank_5_request(self, request: Node) -> Node:
    ...
    def handle_player_rb6_player_write_5_request(self, request: Node) -> Node:
